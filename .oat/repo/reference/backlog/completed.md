...
- 2026-03-19 — bl-cbdd — Optional Codex prompt-wrapper generation for synced OAT skills — Closed as not needed; Codex reads skills directly from .agents/skills/ via TOML adapter, no separate .codex/prompts/ layer exists.
