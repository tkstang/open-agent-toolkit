...
| Provider capability matrix + expanded docs            | Phase 11 | Capability docs already exist. Remaining work is expanding sync support for provider-specific features (e.g., hooks). Now tracked as `bl-aded`. |
